...
<html>
    ...
    <body>
        ...
        <div class="menu">
            ...
            <a href="QLThanhVienController?vaiTro=1&action=view" class="menu-btn menu-active">Nhân Viên</a>
            <a href="QLNhaCungCapController?action=view" class="menu-btn">Nhà Cung Cấp</a>
            <a href="ThongKe.jsp" class="menu-btn">Thống Kê</a>
        </div>
        <div class="container">
            <div class="container-header">
                <a href="TaoMoiThanhVien.jsp?vaiTro=1" class="a-container-header">Tạo mới</a>
            </div>
        ...
        <script>
            ...
            function onDelete(element) {
                ...
                if (result) {
                    ...
                    let url = 'QLThanhVienController?vaiTro=1&action=delete&id=' + id;
